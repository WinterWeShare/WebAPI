...
public class Controller : ControllerBase
{
	...
	public void DeleteToBePaid(int groupId, int userId)
	{
		...
		userToGroupIds.ToList().ForEach(utg => _context.ToBePaids.Remove(_context.ToBePaids.First(t => t.UserToGroupId == utg)));
		_context.SaveChanges();
	}
    ...
    public void DeleteUserFromGroup(int groupId, int userId, int userToRemoveId)
    {
        ...
        var userToRemove = _context.UserToGroups.FirstOrDefault(u => u.UserId == userToRemoveId && u.GroupId == groupId);
